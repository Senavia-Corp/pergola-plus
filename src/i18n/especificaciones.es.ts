...
export const SPECS_COPY: Record<Idioma, Record<string, CopyEspecificaciones>> = {
  en: {
    ...
    'solar-pergolas': {
      ...
      ctaTexto: 'Ask us these five',
      filas: {
        produccion: { etiqueta: 'Output', valor: 'Scales with roof area and orientation. A pergola-sized array is typically a useful supplement — pool pump, lighting, topping up a car — not a whole-house system' },
        estanqueidad: { etiqueta: 'Dry underneath', valor: 'Shaded always; dry only if specified. Panels laid with sealed joints and a gutter behave like a solid roof, panels on rails with gaps do not' },
        carga: { etiqueta: 'What it adds structurally', valor: 'Dead load from the array plus uplift on every panel, engineered into the frame from the start rather than added afterwards' },
        aprobaciones: { etiqueta: 'Approvals', valor: 'Structural and electrical permits, plus an interconnection agreement with your utility and, in many jurisdictions, a separate solar review' },
        montaje: { etiqueta: 'Mounting', valor: 'Attached to the house, or freestanding where the orientation is better' },
        material: { etiqueta: 'Frame material', valor: 'Engineered structural aluminum, powder-coated' },
        acabado: { etiqueta: 'Finish', valor: 'From the powder-coat palette' },
        cableado: { etiqueta: 'Wiring', valor: 'Run inside the structure, so nothing is surface-clipped between the array and the point of connection' },
        plazo: { etiqueta: 'Timeline', valor: 'Several weeks from permit approval to completion, with the utility interconnection running as a second track alongside the build' },
        inversion: { etiqueta: 'Investment', valor: 'Quoted per project: it turns on the array size and the electrical interconnection, so a per-square-foot band would tell you nothing useful' },
        donde: { etiqueta: 'Where we build, and under what licence', valor: 'Miami-Dade, Broward and Palm Beach County. CGC1539940, licensed and insured in Florida' },
      },
      huecos: {
        vataje: 'The kW rating of the array we would put on your roof area, and the yield estimate that goes with it. That comes out of the design, from your consumption and your orientation, and printing an average here would be worse than useless.',
        viento: 'Design wind speed, design pressure and the Miami-Dade NOA number. Each structure is engineered and permitted for its own address; we are not publishing a single figure until it is the one on your drawings.',
        aleacion: 'Aluminium alloy, temper and wall thickness. This is what separates two structures that look identical, and it belongs on the engineering, not in a marketing line.',
        garantia: 'Warranty term, and how it splits between structure, finish and any moving parts. Those are different warranties and we are not going to blur them into one word.',
        financiacion: 'Financing terms. Ask us: we would rather tell you on the phone than publish a rate that changes.',
    ...
    cabanas: {
      ...
      ctaTexto: 'Ask us these five',
      filas: {
        tipo: { etiqueta: 'What it is', valor: 'A small building rather than a shade cover: solid roof, usually walls or screens, and almost always power' },
        techo: { etiqueta: 'Roof', valor: 'Insulated or solid panels, with a finished ceiling underneath' },
        cerramiento: { etiqueta: 'How it closes', valor: 'Motorised screens, fixed decorative panels, partial walls or outdoor-grade drapery — usually a combination, and usually not on all four sides' },
        instalaciones: { etiqueta: 'Power and lighting', valor: 'Recessed lighting, fans and outlets run inside the structure, with the ceiling finished over them' },
        fontaneria: { etiqueta: 'Plumbing', valor: 'An outdoor shower or a bathroom is possible and common by a pool; it brings plumbing permits, a drainage connection and, for a bathroom, ventilation requirements' },
        almacen: { etiqueta: 'Storage', valor: 'It can double as pool equipment storage, but that bay is kept separate and ventilated: chemicals and salt systems corrode metal and electronics in an enclosed space' },
        material: { etiqueta: 'Frame material', valor: 'Engineered structural aluminum, powder-coated' },
        acabado: { etiqueta: 'Finish', valor: 'From the powder-coat palette, plain or in a wood-look texture' },
        permiso: { etiqueta: 'Permitting', valor: 'A permanent structure, permitted as such. Plumbing, if you want it, is permitted alongside' },
        plazo: { etiqueta: 'Timeline', valor: 'Several weeks from permit approval to completion; longer where plumbing is involved, because the lines go in before the surrounding hardscape' },
        // La guia publicada de la empresa da $120-175+ para «Aluminum Cabana
        // Structures», con `fuente: 'publicada'` en el estimador. El «+» significa que
        // el techo es abierto y se arrastra: no es un maximo.
        inversion: { etiqueta: 'Investment', valor: 'An estimated $120 to $175 and upward per square foot installed, from our own published South Florida cost guide. It sits above an open pergola of the same footprint, and it should' },
        donde: { etiqueta: 'Where we build, and under what licence', valor: 'Miami-Dade, Broward and Palm Beach County. CGC1539940, licensed and insured in Florida' },
      },
      huecos: {
        medidas: 'Maximum clear span and module sizes. We size every structure from the calculation for your site, and we do not publish a catalogue span.',
        viento: 'Design wind speed, design pressure and the Miami-Dade NOA number. Each structure is engineered and permitted for its own address; we are not publishing a single figure until it is the one on your drawings.',
        aleacion: 'Aluminium alloy, temper and wall thickness. This is what separates two structures that look identical, and it belongs on the engineering, not in a marketing line.',
        garantia: 'Warranty term, and how it splits between structure, finish and any moving parts. Those are different warranties and we are not going to blur them into one word.',
        financiacion: 'Financing terms. Ask us: we would rather tell you on the phone than publish a rate that changes.',
  ...
  es: {
    ...
    'solar-pergolas': {
      ...
      ctaTexto: 'Pregúntenos estos cinco',
      filas: {
        produccion: { etiqueta: 'Producción', valor: 'Va con la superficie de cubierta y la orientación. Un campo del tamaño de una pérgola suele ser un complemento útil —bomba de piscina, iluminación, recargar el coche—, no un sistema para toda la casa' },
        estanqueidad: { etiqueta: 'Seco debajo', valor: 'Con sombra siempre; seco solo si se especifica. Los paneles montados con juntas selladas y canalón se comportan como una cubierta maciza; sobre rieles con separación, no' },
        carga: { etiqueta: 'Lo que añade a la estructura', valor: 'El peso propio del campo más la succión sobre cada panel, calculados en la estructura desde el principio y no añadidos después' },
        aprobaciones: { etiqueta: 'Aprobaciones', valor: 'Permisos de estructura y electricidad, más el acuerdo de interconexión con su compañía eléctrica y, en muchos municipios, una revisión solar aparte' },
        montaje: { etiqueta: 'Montaje', valor: 'Adosada a la casa, o exenta donde la orientación sea mejor' },
        material: { etiqueta: 'Material de la estructura', valor: 'Aluminio estructural calculado, con recubrimiento en polvo' },
        acabado: { etiqueta: 'Acabado', valor: 'De la carta de recubrimiento en polvo' },
        cableado: { etiqueta: 'Cableado', valor: 'Va por dentro de la estructura, así que no hay nada grapado por fuera entre el campo y el punto de conexión' },
        plazo: { etiqueta: 'Plazo', valor: 'Varias semanas desde la aprobación del permiso hasta el final, con la interconexión con la eléctrica corriendo en paralelo a la obra' },
        inversion: { etiqueta: 'Inversión', valor: 'Se cotiza por proyecto: depende del tamaño del campo y de la interconexión eléctrica, así que una banda por pie cuadrado no le diría nada útil' },
        donde: { etiqueta: 'Dónde construimos, y con qué licencia', valor: 'Miami-Dade, Broward y Palm Beach. CGC1539940, con licencia y seguro en Florida' },
      },
      huecos: {
        vataje: 'Los kW del campo que pondríamos en su superficie de cubierta y la estimación de producción que va con ellos. Eso sale del diseño, de su consumo y de su orientación, y publicar aquí una media sería peor que no decir nada.',
        viento: 'Velocidad de viento de diseño, presión de diseño y número de NOA de Miami-Dade. Cada estructura se calcula y se permisa para su propia dirección; no vamos a publicar ni una cifra hasta que sea la de sus planos.',
        aleacion: 'Aleación del aluminio, temple y espesor de pared. Es lo que separa dos estructuras que parecen iguales, y su sitio es el cálculo, no una línea de marketing.',
        garantia: 'Años de garantía, y cómo se reparte entre estructura, acabado y las partes móviles. Son garantías distintas y no las vamos a resumir en una palabra.',
        financiacion: 'Condiciones de financiación. Pregúntenos: preferimos decírselo por teléfono antes que publicar un tipo que cambia.',
    ...
    cabanas: {
      ...
      ctaTexto: 'Pregúntenos estos cinco',
      filas: {
        tipo: { etiqueta: 'Qué es', valor: 'Un edificio pequeño, no una cubierta de sombra: techo macizo, casi siempre paredes o celosías, y casi siempre corriente' },
        techo: { etiqueta: 'Techo', valor: 'Paneles aislados o macizos, con techo acabado por debajo' },
        cerramiento: { etiqueta: 'Cómo se cierra', valor: 'Cortinas motorizadas, paneles decorativos fijos, paredes parciales o cortinaje de exterior; normalmente una combinación, y normalmente no en los cuatro lados' },
        instalaciones: { etiqueta: 'Corriente e iluminación', valor: 'Focos empotrados, ventiladores y enchufes por dentro de la estructura, con el techo acabado por encima' },
        fontaneria: { etiqueta: 'Fontanería', valor: 'Una ducha exterior o un baño se puede y es habitual junto a la piscina; trae permisos de fontanería, conexión de desagüe y, si es baño, requisitos de ventilación' },
        almacen: { etiqueta: 'Almacenaje', valor: 'Puede hacer también de cuarto de máquinas de la piscina, pero ese vano va separado y ventilado: los productos químicos y los cloradores salinos corroen el metal y la electrónica en un espacio cerrado' },
        material: { etiqueta: 'Material de la estructura', valor: 'Aluminio estructural calculado, con recubrimiento en polvo' },
        acabado: { etiqueta: 'Acabado', valor: 'De la carta de recubrimiento en polvo, liso o con textura tipo madera' },
        permiso: { etiqueta: 'Permisos', valor: 'Es una estructura permanente y se permisa como tal. La fontanería, si la quiere, se permisa a la vez' },
        plazo: { etiqueta: 'Plazo', valor: 'Varias semanas desde la aprobación del permiso hasta el final; más si hay fontanería, porque las líneas van antes que el pavimento de alrededor' },
        inversion: { etiqueta: 'Inversión', valor: 'Una banda estimada de 120 a 175 dólares por pie cuadrado instalado y hacia arriba, de nuestra propia guía de costes del sur de Florida. Está por encima de una pérgola abierta de la misma superficie, y tiene que estarlo' },
        donde: { etiqueta: 'Dónde construimos, y con qué licencia', valor: 'Miami-Dade, Broward y Palm Beach. CGC1539940, con licencia y seguro en Florida' },
      },
      huecos: {
        medidas: 'Luz máxima y medidas de módulo. Cada estructura se dimensiona a partir del cálculo de su parcela, y no publicamos una luz de catálogo.',
        viento: 'Velocidad de viento de diseño, presión de diseño y número de NOA de Miami-Dade. Cada estructura se calcula y se permisa para su propia dirección; no vamos a publicar ni una cifra hasta que sea la de sus planos.',
        aleacion: 'Aleación del aluminio, temple y espesor de pared. Es lo que separa dos estructuras que parecen iguales, y su sitio es el cálculo, no una línea de marketing.',
        garantia: 'Años de garantía, y cómo se reparte entre estructura, acabado y las partes móviles. Son garantías distintas y no las vamos a resumir en una palabra.',
        financiacion: 'Condiciones de financiación. Pregúntenos: preferimos decírselo por teléfono antes que publicar un tipo que cambia.',
