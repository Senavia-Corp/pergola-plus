...
const PROPIAS = {
  ...
  '/products/motorized-screens': {
    razon:
      'ficha recompuesta, mismo molde: `services` sale entero y su hueco lo ocupa el bloque comparativo',
    permitidos: {
      'af395482-435a-2143-5385-d4f1e6bdca74':
        '.header-services -> el bloque de servicios se retira de esta ficha; el enlace a /services/pergola-design-construction se repone en la entradilla del proceso',
      'af395482-435a-2143-5385-d4f1e6bdca7b':
        '.wrapper-services -> la rejilla de las 7 tarjetas de servicio. Su turno OSCURO lo cubre la seccion de especificaciones, que entra con [data-pp-reveal]',
    },
    anadidos: {
      'a36f2a1e-9f59-c2af-809a-f51186a9ca93':
